...
const {TimeoutError, CrashError} = require('./Errors');
...
class NavigatorWatcher {
  ...
  constructor(client, frameManager, frame, timeout, options = {}) {
    ...
    this._eventListeners = [
      ...
      helper.addEventListener(client, 'Inspector.targetCrashed', () => this._terminate(new CrashError('Navigation failed because target crashed!')))
    ];
